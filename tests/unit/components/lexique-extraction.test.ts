...
describe('LexiquePanel', () => {
  ...
  // (bouton « Verrouiller le Lexique », état verrouillé, cases désactivées) sont
  // retirés : ce verrouillage n'existe plus. Chaque case retient son terme
  // (FR-LEX-CHECKBOX-LOCK-IMMEDIATE) ; la porte et l'étape sont couvertes par
  // lexique-gate.test.ts.
})
