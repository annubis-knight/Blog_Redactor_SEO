...
48 prompts. Variables globales, fournies par le chargeur quand un prompt les cite : `strategy_context`, `today`, `year`, `zone`, `zone_landmarks`.
...
| `enrich-exemples.md` | Passe exemples : ajoute un exemple en situation à un chapitre | `articleText`, `chapterHtml`, `keyword`, `keywords` | `zone`, `zone_landmarks` | `zone`, `zone_landmarks` | `server/services/article/enrichment.service.ts` |
| `enrich-faq.md` | Passe FAQ : écrit le chapitre « Questions fréquentes » de l’article | `articleText`, `keyword`, `keywords` | — | — | `server/services/article/enrichment.service.ts` |
| `enrich-images.md` | Passe images : place une image à fournir et son texte alternatif | `articleText`, `chapterHtml`, `imageSrc`, `keyword`, `keywords` | — | — | `server/services/article/enrichment.service.ts` |
| `enrich-sources.md` | Passe sources : remplace les « à sourcer » d’un chapitre par des données trouvées par la recherche web, liens réels | `articleText`, `chapterHtml`, `keyword`, `keywords` | `zone` | `today`, `zone` | `server/services/article/enrichment.service.ts` |
| `enrich-tableaux.md` | Passe tableaux : ajoute un tableau quand le chapitre compare ou énumère | `articleText`, `chapterHtml`, `keyword`, `keywords` | — | — | `server/services/article/enrichment.service.ts` |
...
| `section-rewrite.md` | Réécrit un chapitre selon une consigne, en voyant l’article entier | `articleText`, `chapterHtml`, `instruction`, `keyword`, `keywords` | — | — | `server/services/article/enrichment.service.ts` |
