...
| `lieutenants-hn-structure.md` | Structure H2/H3 à partir des lieutenants retenus | `cocoon_articles`, `hn_structure`, `keyword`, `level`, `lieutenants`, `locked_headings`, `painPoint`, `type_rules` | `cocoon_articles` | `strategy_context` | `server/routes/keyword-ai-panel.routes.ts` |
