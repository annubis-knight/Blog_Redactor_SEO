...
- [ ] **Task 1 : Créer `src/constants/french-nlp.ts`**
...
- [ ] **Task 2 : Remplacer les imports de FRENCH_STOPWORDS**
...
- [ ] **Task 3 : Créer `src/utils/text-utils.ts`**
...
- [ ] **Task 4 : Remplacer les stripHtml dupliqués**
...
- [ ] **Task 5 : Refactorer `api.service.ts`**
...
- [ ] **Task 7 : Créer `CaptainVerdictPanel.vue`**
...
- [ ] **Task 8 : Créer `CaptainCarousel.vue`**
...
- [ ] **Task 9 : Créer `CaptainAiPanel.vue`**
...
- [ ] **Task 10 : Créer `CaptainInteractiveWords.vue`**
...
- [ ] **Task 11 : Créer `CaptainLockPanel.vue`**
...
- [ ] **Task 12 : Refactorer CaptainValidation.vue comme orchestrateur**
...
- [ ] **Task 13 : Créer `LieutenantSerpAnalysis.vue`**
...
- [ ] **Task 14 : Créer `LieutenantH2Structure.vue`**
...
- [ ] **Task 15 : Créer `LieutenantProposals.vue`**
...
- [ ] **Task 16 : Créer `LieutenantCardGrid.vue`**
...
- [ ] **Task 17 : Refactorer LieutenantsSelection.vue comme orchestrateur**
...
- [ ] **Task 18 : Créer `useDiscoveryCache.ts`**
...
- [ ] **Task 19 : Créer `useRelevanceScoring.ts`**
...
- [ ] **Task 20 : Créer `useDiscoverySelection.ts`**
...
- [ ] **Task 21 : Refactorer useKeywordDiscoveryTab.ts**
...
- [ ] **Task 22 : Tests des sous-composants CaptainValidation**
...
- [ ] **Task 23 : Tests des composables extraits**
