...
**Statut** : livrée par C4 (versée au PRD et au registre, 2026-09-25). Texte amendé à la livraison, le PRD fait foi : aucune règle de nombre de FAQ n'existe encore (elle viendra avec la passe FAQ, C5) ; un seuil d'alerte (« contenu mince ») reste distinct de la borne basse de la cible, dans la même source ; le vérificateur de publication suit le plafond du type, pas la longueur visée.
