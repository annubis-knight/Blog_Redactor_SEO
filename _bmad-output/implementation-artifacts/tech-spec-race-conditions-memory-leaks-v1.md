...
- [ ] **Task 1 : Séparer les flags dans strategy.store.ts**
...
- [ ] **Task 2 : Séparer les flags dans gsc.store.ts**
...
- [ ] **Task 3 : Ajouter AbortController dans keyword-discovery.store.ts**
...
- [ ] **Task 4 : Ajouter AbortController dans brief.store.ts**
...
- [ ] **Task 5 : Propager le signal AbortController dans api.service.ts**
...
- [ ] **Task 6 : Ajouter cleanup et LRU à article-progress.store.ts**
...
- [ ] **Task 7 : Ajouter onBeforeUnmount dans useResonanceScore.ts**
...
- [ ] **Task 8 : Ajouter cleanup dans useKeywordDiscoveryTab.ts**
...
- [ ] **Task 9 : Ajouter cleanup dans useNlpAnalysis.ts**
