...
>
> Snapshot pré-brainstorming du 2026-03-30. Superseded par l'implémentation actuelle.
> Pour l'état livré, voir `_bmad-output/planning-artifacts/prd.md`, `architecture.md`, `epics.md`.
